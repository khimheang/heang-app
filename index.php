...
<body>
        ...
        <nav class="navbar navbar-expand-md fixed-top navbar-dark nav-background">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a id="C-W" class="nav-link" href="">
                            <i class="fas fa-tablet-alt">&nbsp;</i>Technology</a>
                    </li>
                    <li class="nav-item">
                        <a id="C-W" class="nav-link" href="">
                    ...
                    <li class="nav-item">
                        <a id="C-W" class="nav-link" href="">
                            <i class="fas fa-globe-asia">&nbsp;</i>Contact</a>
                    </li>
                </ul>
                <div class="form-inline mt-2 mt-md-0">
                    ...
                    <button onclick="document.getElementById('loginanimate').style.display='block'" class="btn btn-outline-success my-2 my-sm-0 form-control"
                        data-toggle="collapse" data-target="#navbarCollapse">Login</button>
                </div>
            </div>
        </nav>
    </div>
    ...
    <div class="nav-footer">
        <p>HEANG123 built for
            <a href="">Group Assignment</a> by
            <a href="https://www.facebook.com/dara.khimheang" target="_blank">@Dara.Khimheang</a>.</p>
        <p>
        ...
        <div class="modal-content animate">
            <form action="">
                <div class="container">
                    ...
                    <span class="create my-2 float-left">Create new
                        <a href="#" title="Create New">
                            <u>account</u>
                        </a>
                    </span>
                    <span class="psw my-2 float-right">Forgot
                        <a href="#">
                            <u>password?</u>
                        </a>
                    </span>
